...
# Second Best Model: MLP Regressor with Optimal Parameters
best_params = {'hidden_layer_sizes': (100,), 'activation': 'relu', 'max_iter': 10000}  # From results
...
print(f"MLP Regressor - MSE: {mlp_mse}, R²: {mlp_r2}")
